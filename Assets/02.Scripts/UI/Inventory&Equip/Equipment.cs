...
public class Equipment : MonoBehaviour
{
    ...
    public ItemInfo[] equipItemList; // 장착된 장비 리스트.
    ...
    public void EquipItemCheck(int _count, ItemInfo _item)
    {
    ...
    IEnumerator OOCCoroutine(string _up, string _down)
    {
        ...
        if (theOOC.GetResult())
        {
            equipItemList[selectedSlot] = new ItemInfo(0, "", "", ItemInfo.ItemType.Equip);
