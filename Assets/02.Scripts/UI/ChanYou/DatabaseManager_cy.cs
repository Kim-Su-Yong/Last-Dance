...
public class DatabaseManager_cy : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //itemList.Add(new Item_cy(10002, "파란 포션", "마나를 15 회복시켜주는 기적의 물약", Item_cy.ItemType.Consume));
        //itemList.Add(new Item_cy(10003, "농축 빨간 포션", "체력을 350 회복시켜주는 기적의 농축 물약", Item_cy.ItemType.Consume));
        //itemList.Add(new Item_cy(10004, "농축 파란 포션", "마나를 80 회복시켜주는 기적의 농축 물약", Item_cy.ItemType.Consume));
